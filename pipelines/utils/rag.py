...
# Prompt function
def create_prompt(user_message, docs_retriever):
    # Config prompt
    ...
    qa_prompt_str = qa_prompt_str.format(context_str=docs_retriever, query_str=user_message)
...
def retrieve_func(index, top_k, user_message, service_context, text_qa_template):
    ...
    # Get prompt
    text_qa_template, refine_template = create_prompt(user_message=user_message, docs_retriever=format_relevance_docs)
